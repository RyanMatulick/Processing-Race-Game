...
void draw()
{
  ...
  if (PlayGame == false)
  {
    if (ImageEditor == true)
    {
      try 
     {
        Runtime.getRuntime().exec("cmd /c" + "START C://Users//Ryan//Documents//GitHub//Processing-Race-Game//3D//3D_game_called_Testing_Tool//Testing_Tool//Move_Shapes//application_windows64//Test.bat");
     }
